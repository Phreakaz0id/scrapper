...
class MaxiconsumoSpider(scrapy.Spider):
    ...
    def login(self):
        ...
        user_input.send_keys('Javierysurieta@gmail.com')

        password_input = self.driver.find_element(By.XPATH, '//*[@id="pass"]')
        password_input.send_keys('javier8332')

        enter_button = self.driver.find_element(By.XPATH, '//*[@id="send2"]')
        enter_button.click()

    def parse(self, response):
        self.driver.get('https://maxiconsumo.com/sucursal_burzaco/limpieza.html?p=10&product_list_limit=96')
        wait = WebDriverWait(self.driver, 5)
        ...
        # //*[@id="catalog-listing"]/div[2]/ol/ul
